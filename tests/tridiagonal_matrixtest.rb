...
class TridiagonalMatrixTest < Test::Unit::TestCase
	...
	def test_divide
		...
		dividedMatrix = Matrix.rows([[-2,-2],[-6,-2]])
		matrix1_1 = TriDiagonalMatrix.new([[2,4],[6,8]])
		matrix2_2 = TriDiagonalMatrix.new([[-1, -1],[0,-1]])
		assert_equal(dividedMatrix, matrix1_1/matrix2_2)
	end
